...
if enable_sentry then
  ...
  if sentry_loaded and Sentry then
    pcall(Sentry().init, { dsn = "https://dda71f36d7304ecc8cf1e228582f3367@o1272228.ingest.sentry.io/6529866" })
  end
end
...
if enable_autoupdate then
  ...
  if updater_loaded then
    ...
    if autoupdate_loaded then
      Update.json_url = json_update_link .. "?" .. tostring(os.clock())
      Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
      Update.url = "https://github.com/qrlk/gmap"
    end
  end
end
...
function updatechangelog()
  ...
  add_to_changelog("v25.06.2022",
      "Добавлена система сбора ошибок скрипта\n"..
          "Система автообновления заменена на более стабильную\n"
  )
